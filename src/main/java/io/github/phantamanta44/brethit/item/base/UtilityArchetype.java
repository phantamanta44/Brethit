...
public enum UtilityArchetype {
    ...
    ANCIENT("ancient", 17, 1.9F, 20F, Constants.BASE_AS, true, EnumRarity.UNCOMMON), // TODO guardian armour pierce
    ANCIENT2("ancient2", 26, 1.95F, 30F, Constants.BASE_AS, true, EnumRarity.RARE),
    ANCIENT3("ancient3", 32, 2F, 40F, Constants.BASE_AS, true, EnumRarity.EPIC),
    BOKO("boko", 8, 1F, 4F),
    BOKO2("boko2", 14, 1F, 12F, EnumRarity.UNCOMMON),
    BOKO3("boko3", 18, 1F, 24F, EnumRarity.RARE),
    MOBLIN("moblin", 10, 1.3F, 6F),
    MOBLIN2("moblin2", 14, 1.3F, 18F, EnumRarity.UNCOMMON),
    MOBLIN3("moblin3", 19, 1.3F, 30F, EnumRarity.RARE),
    STAL("stal", 5, 0.8F, 5F),
    STAL2("stal2", 8, 0.8F, 12F),
    STAL3("stal3", 5, 0.8F, 15F),
    GORON("goron", 30, 1.75F, 15F, EnumRarity.UNCOMMON),
    GORON2("goron2", 40, 1.9F, 42F, EnumRarity.RARE),
    LIZAL("lizal", 17, 1.55F, 14F, EnumRarity.UNCOMMON),
    LIZAL2("lizal2", 25, 1.75F, 24F, EnumRarity.RARE),
    LIZAL3("lizal3", 27, 1.8F, 36F, EnumRarity.RARE),
    FARMER("farmer", 5, 1.7F, 9F),
    RITO("rito", 27, 2F, 15F, EnumRarity.UNCOMMON),
    KOROK("korok", 27, 1.5F, 22F, EnumRarity.UNCOMMON),
    GERUDO("gerudo", 23, 1.75F, 18F, EnumRarity.UNCOMMON),
    ZORA("zora", 27, 1.7F, 15F, EnumRarity.UNCOMMON),
    SHEIKAH("sheikah", 26, 1.8F, 15F, EnumRarity.UNCOMMON),
    YIGA("yiga", 14, 1.8F, 16F, EnumRarity.RARE),
    YIGA2("yiga2", 25, 1.8F, 40F, EnumRarity.EPIC),
    RUSTY("rusty", 8, 1.45F, 6F),
    TRAVELER("traveler", 20, 1.6F, 5F),
    SOLDIER("soldier", 14, 1.75F, 25F, EnumRarity.UNCOMMON),
    KNIGHT("knight", 27, 1.8F, 27F, EnumRarity.UNCOMMON),
    ROYAL("royal", 36, 1.9F, 36F, EnumRarity.RARE),
    CALAMITY("calamity", 14, 2.2F, 48F, EnumRarity.EPIC),
    LYNEL("lynel", 26, 1.7F, 24F, EnumRarity.RARE),
    LYNEL2("lynel2", 32, 1.75F, 36F, EnumRarity.RARE),
    LYNEL3("lynel3", 41, 1.8F, 58F, EnumRarity.EPIC),
    FLAME("elem_fire", 36, 1.4F, 24F, EnumRarity.RARE),
    FROST("elem_ice", 30, 1.5F, 20F, EnumRarity.RARE),
    THUNDER("elem_elec", 36, 1.6F, 22F, EnumRarity.RARE),
