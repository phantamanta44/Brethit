...
public class BrethitItems {
    ...
    public static class WEAPON {
        ...
        public static void init() {
            ...
            ANCIENT_BLADESAW = new ItemUtilityUnique("w_bladesaw", UtilityClass.W_CLEAVER, 50, 55F, 1.3F, EnumRarity.EPIC, true);
            ANCIENT_SHORT_SWORD = new ItemUtilityUnique("w_ancient_shortsword", UtilityClass.W_SWORD, 54, 40F, 1.7F, EnumRarity.EPIC, true);
            ANCIENT_SPEAR_UNIQ = new ItemUtilityUnique("w_ancient_spear_unique", UtilityClass.W_SPEAR, 50, 30F, 1.95F, EnumRarity.EPIC, true);
            ...
            BOULDER_BREAKER = new ItemUtilityUnique("w_champ_goron", UtilityClass.W_CLUB_HEAVY, 60, 60F, 1F, EnumRarity.EPIC);
            LIGHTSCALE_TRIDENT = new ItemUtilityUnique("w_champ_zora", UtilityClass.W_SPEAR, 70, 22F, 2F, EnumRarity.EPIC);
            SEVEN_BLADE = new ItemUtilityUnique("w_champ_gerudo", UtilityClass.W_SWORD, 60, 32F, 1.7F, EnumRarity.EPIC);
            CEREMONIAL_TRIDENT = new ItemUtilityUnique("w_ceremonial_trident", UtilityClass.W_SPEAR, 40, 14F, 1.8F, EnumRarity.UNCOMMON);
            ...
            DOUBLE_AXE = new ItemUtilityUnique("w_double_axe", UtilityClass.W_BAXE, 52, 18F, 1.3F, EnumRarity.UNCOMMON);
            DRILLSHAFT = new ItemUtilityUnique("w_drillshaft", UtilityClass.W_SPEAR, 50, 14F, 2.5F, EnumRarity.UNCOMMON);
            DUALITY_SWORD = new ItemUtilityUnique("w_duality_sword", UtilityClass.W_CLEAVER, 5, 50F, 1.3F, EnumRarity.EPIC);
            SHEIKAH_BLADE = new ItemSword(SHEIKAH);
            SHEIKAH_LONGBLADE = new ItemUtilityUnique("w_sheikah_longblade", UtilityClass.W_CLEAVER, 25, 32F, 1.4F, EnumRarity.RARE);
            ...
            GODDESS_SWORD = new ItemUtilityUnique("w_dlc_goddess", UtilityClass.W_SWORD, 45, 28F, 1.5F, EnumRarity.EPIC);
            SAGE_SWORD = new ItemUtilityUnique("w_dlc_sage", UtilityClass.W_SWORD, 50, 48F, 1.7F, EnumRarity.EPIC);
            BIGGORON_SWORD = new ItemUtilityUnique("w_dlc_biggoron", UtilityClass.W_CLEAVER, 60, 50F, 1F, EnumRarity.EPIC);
            FIERCE_DEITY_SWORD = new ItemUtilityUnique("w_dlc_majora", UtilityClass.W_SWORD, 35, 60F, 1.65F, EnumRarity.EPIC);
            SLEDGEHAMMER = new ItemUtilityUnique("w_sledgehammer", UtilityClass.W_CLUB_HEAVY, 40, 12F, 1.4F);
            ...
            MASTER_SWORD = new ItemUtilityUnique("w_master_sword", UtilityClass.W_SWORD, 40, 40F, 1.7F, EnumRarity.EPIC);
            ...
            MOONLIGHT_SCIMITAR = new ItemUtilityUnique("w_moonlight_scimitar", UtilityClass.W_SWORD, 32, 25F, 1.6F, EnumRarity.RARE);
            ZORA_CLEAVER = new ItemCleaver(ZORA);
            ZORA_SPEAR = new ItemSpear(ZORA);
            ZORA_SWORD = new ItemSword(ZORA);
            SILVERSCALE_SPEAR = new ItemUtilityUnique("w_silverscale_spear", UtilityClass.W_SPEAR, 40, 12F, 1.8F, EnumRarity.UNCOMMON);
            STICK = new ItemUtilityUnique("w_stick", UtilityClass.W_CLUB, 4, 2F, 0.5F);
            WOODCUTTER_AXE = new ItemUtilityUnique("w_woodcutter_axe", UtilityClass.W_BAXE, 47, 3F, 1.5F);
        }
